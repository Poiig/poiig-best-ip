...
(Get-Content us.txt) | ForEach-Object { $_ -replace '^(.*)$', '$1#US-$1' } | Set-Content us.txt
...
(Get-Content uk.txt) | ForEach-Object { $_ -replace '^(.*)$', '$1#英国-$1' } | Set-Content uk.txt
...
(Get-Content hk.txt) | ForEach-Object { $_ -replace '^(.*)$', '$1#HK-$1' } | Set-Content hk.txt
